    ...
    <div style={{ minHeight: '100vh', background: bg, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '6rem 2rem 4rem', position: 'relative', zIndex: 10 }}>
        ...
        {[
          ...
          { title: '7. Your Rights', content: 'You have the right to access, export, or delete your data at any time. To submit a data request, contact us at privacy@zed.app or call +1 (579) 471-3458. We will respond within 30 days. EU and UK users have additional rights under GDPR and UK GDPR respectively.' },
          ...
          { title: '9. Contact', content: 'Zed Technologies Inc. — privacy@zed.app — +1 (579) 471-3458' },
        ].map((sec, i) => (
